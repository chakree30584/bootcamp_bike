        ...
        <div class="container">
            ...
            <div id="mid_menu" class="col-sm-12 col-md-12">
                ...
                <div class="page-header">
                    <h1>Admin <small>Information - Change Information</small></h1>
                </div>
                            ...
                            <form id="changeInfoUser" class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                               ...
                                               <input type="text" class="form-control" id="inputPassword3" value="<% User user = (User) session.getAttribute("user");
                                                   out.print(user.getId()); %>" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Mail : </label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="position" placeholder="E-Mail" value="<%out.print(user.getMail());%>" disabled>
                                    </div>
                                </div>						  
                                <div class="form-group">
...
">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="Name" name="name" value="<%=user.getName()%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Position : </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="position" value="Admin" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Tel. : </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="position" placeholder="Telephone number" name="tel" value="<%=user.getTel()%>">
                                    </div>
                                </div>
